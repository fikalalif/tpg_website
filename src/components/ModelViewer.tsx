...
const ModelViewer = () => {
  ...
  useEffect(() => {
    ...
    loader.load("/base.obj", (loadedObject) => {
      ...
      // Set semua material menjadi warna putih
  ...
  return (
    <div className="absolute inset-0 flex justify-center items-center z-10 [perspective:1000px]">
      <div
        ref={mountRef}
        className="flex justify-center items-center w-3/4 sm:w-2/4 md:w-1/3 lg:w-1/4 xl:w-1/5 max-w-xs sm:max-w-sm md:max-w-lg mt-44 h-[800px]"
      />
    </div>
  );
};
